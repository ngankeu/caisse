...
class SettingController extends Controller
{
    ...
    public function UpdateSmtpSetting(Request $request){
        ...
        $notification = array(
            'message' => 'Le paramètre Smtp a été mis à jour avec succès',
            'alert-type' => 'success'
        );
    ...
    public function UpdateSiteSetting(Request $request){
        ...
        if ($request->file('logo')) {
            ...
            $notification = array(
                'message' => 'SiteSetting mis à jour avec succès avec l\'image',
                'alert-type' => 'success'
            );
            ...
            $notification = array(
                'message' => 'SiteSetting mis à jour sans image avec succès',
                'alert-type' => 'success'
            );
