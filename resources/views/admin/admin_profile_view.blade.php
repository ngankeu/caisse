                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Profil d'administrateur</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Profil d'administrateur</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="row">
        ...
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="text-start mt-3">
                    ...
                    <p class="text-muted mb-2 font-13"><strong>Nom et prénom :</strong> <span class="ms-2">{{ $adminData->name }}</span></p>
                
                    <p class="text-muted mb-2 font-13"><strong>Téléphonee :</strong><span class="ms-2">{{ $adminData->phone }}</span></p>
   ...
   <div class="col-md-12">
<div class="mb-3">
        <label for="example-fileinput" class="form-label">Image du profil d'administrateur</label>
