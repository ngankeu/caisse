                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Changer le mot de passe</a></li>
...
<div class="row">
    ...
    <div class="col-md-12">
     ...
     <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">Confirmer le nouveau mot de passe</label>
