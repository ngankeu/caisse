...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">Page non trouvée </h3>
                                    <p class="text-muted mb-0">Il semblerait que vous ayez pris un lien erroné. Ne vous inquiétez pas...
                                        Vous voudrez peut-être vérifier votre connexion Internet ou revenir à l'accueil?
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Retourner à <a href="{{ route('dashboard') }}" class="text-white ms-1"><b> L'accueil</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; Par Ngankeu Alain pierre <a href="">Tel: 698323606</a>
        </footer>
