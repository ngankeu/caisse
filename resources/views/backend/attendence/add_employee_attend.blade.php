               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <h4>
                        ...
                        <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>Liste de présence des employés</a>
                     </h4>
                  </ol>
               </div>
            </div>
               ...
               <div class="card-body">
                  <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                     ...
                     <div class="form-group col-md-4">
                        <label for="date" class="control-label">Date de présence</label>
                     ...
                     <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                        <thead>
                           <tr>
                              ...
                              <th rowspan="2" class="text-center" style="vertical-align: middle">Nom de l'employé</th>
                              <th colspan="3" class="text-center" style="vertical-align: middle">Statut de présence</th>
                           </tr>
                           <tr>
                              <th class="text-center btn present_all" style="display: table-cell;background-color:#114190">Présent(e)</th>
                              <th class="text-center btn leave_all" style="display: table-cell;background-color:#114190">Parti(e)</th>
                              <th class="text-center btn absent_all" style="display: table-cell;background-color:#114190">Absent(e)</th>
                           </tr>
                        </thead>
    <tbody>
