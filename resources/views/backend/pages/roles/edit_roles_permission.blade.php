            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Modifier le rôle avec autorisation</a></li>
                        
                    </ol>
                </div>
                <h4 class="page-title">Modifier le rôle avec autorisation</h4>
            </div>
        </div>
    </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        ...
        <div class="form-group mb-3">
            <label for="firstname" class="form-label"> Nom des rôles </label>
            <h3> {{ $role->name }} </h3>
       ...
       <div class="form-check mb-2 form-check-primary">
        ...
        <label class="form-check-label" for="customckeck15">Primaire</label>
       </div>
