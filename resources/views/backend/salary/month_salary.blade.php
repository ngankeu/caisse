    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('month.now.salary', ['id' => $item->id]) }}" class="btn btn-blue rounded-pill waves-effect waves-light">History</a>
                    <a href="{{ route('delete.history.salary',$item->id) }}" class="btn btn-danger rounded-pill waves-effect waves-light" id="delete">Delete</a>
