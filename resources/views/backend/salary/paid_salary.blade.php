                                        ...
                                        <div class="col-md-6">
                                            @if(isset($paysalary))
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($paysalary['advance']))
                                                        <strong style="color: #000000;">{{ $paysalary['advance']['advance_salary'] }}</strong>
                                                        <input type="hidden" name="advance_salary" value="{{ $paysalary['advance']['advance_salary'] }}">
                                                    @else
                                                        <span style="color: #cd0a0a;">Pas d'avance sur salaire</span>
                                                    @endif
                                                </div>

                                                @php
                                                    $amount = $paysalary->salary - optional($paysalary['advance'])['advance_salary'];
                                                @endphp
                                            @else
                                                <p style="color: #000000;">No payment details available.</p>
                                            @endif
                                        </div>
