            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <strong style="color: #000000;">{{ $historySalary->salary }}</strong>
                        <input type="hidden" name="paid_amount" value="{{ $historySalary->salary }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <strong style="color: #000000;">{{ $historySalary->advance->advance_salary }}</strong>
                        <input type="hidden" name="advance_salary" value="{{ $historySalary->advance->advance_salary }}">
                    </div>
                </div>

                @php
                    $amount = $historySalary->salary - $historySalary->advance->advance_salary;
                @endphp
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <strong style="color: #000000;">
                            @if($historySalary->advance->advance_salary == null)
                                <span>No Salary</span>
                            @else
                                {{ round($amount) }}
                            @endif
