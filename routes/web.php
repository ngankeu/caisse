...
/// Advance Salary All Route
    Route::controller(SalaryController::class)->group(function(){
        ...
        Route::get('delete/advance-salary/{id}','deleteAdvance')->name('delete.advance.salary');
...
/// Pay Salary All Route
    Route::controller(SalaryController::class)->group(function(){
        ...
        Route::get('month/salary/{id}','monthNowSalary')->name('month.now.salary');
        Route::get('history/{id}','payHistoryDetail')->name('month.payHistoryDetail');
        Route::get('delete/month/{id}','deleteMonth')->name('delete.history.salary');
    });
